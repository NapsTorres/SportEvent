...
const BracketSample = () => {
  ...
  useEffect(() => {
    ...
    axios.get('http://localhost:9000/api/matches/match-list')
      .then(response => {
  ...
  return (
    <div className='flex flex-col w-full justify-center items-center h-screen'>
      <h1 className="text-2xl font-bold mb-4 text-center">Basketball Bracket</h1>
      {matches.length > 0 && (
